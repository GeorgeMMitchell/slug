...
TEST_CASE("Native Global Macro", "[globals]") {
  ...
  SLUG_LOG(
    slug::trace, "Test {} message from global logging instance", "console");
...
TEST_CASE("Wide Global Macro", "[globals]") {
  ...
  SLUG_W_LOG(
    slug::trace, L"Test {} message from global logging instance", L"console");

  SLUG_W_OPEN_FILE(slug::test::config::out_filename, std::ios::app);

  SLUG_W_LOG(
    slug::trace, L"Test {} message from global logging instance", L"file");
